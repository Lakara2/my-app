...
const EquipementForm = ({ equipementId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      parseInt(anneeFabrication) > currentYear ||
      parseInt(anneeFabrication) < 1900
    ) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        <label htmlFor="paysOrigine" className="form-label">
          Pays d'origine :
        </label>
        <input
          type="text"
      ...
      <div className="mb-3">
        <label htmlFor="anneeFabrication" className="form-label">
      ...
      <div className="mb-3">
        <label htmlFor="prixUnitaire" className="form-label">
          Prix unitaire :
        </label>
        <input
          type="number"
      ...
      <div className="mb-3">
        <label htmlFor="commande" className="form-label">
          Commande :
        </label>
        {commandeId ? (
